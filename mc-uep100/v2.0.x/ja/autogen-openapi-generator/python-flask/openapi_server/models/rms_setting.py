...
class RmsSetting(Model):
    ...
    def __init__(self, lower_frq_hz=10, upper_frq_hz=80000, time_sec=0.0512):  # noqa: E501
        """RmsSetting - a model defined in OpenAPI

        :param lower_frq_hz: The lower_frq_hz of this RmsSetting.  # noqa: E501
        :type lower_frq_hz: int
        :param upper_frq_hz: The upper_frq_hz of this RmsSetting.  # noqa: E501
        :type upper_frq_hz: int
        :param time_sec: The time_sec of this RmsSetting.  # noqa: E501
        :type time_sec: float
        """
        self.openapi_types = {
            'lower_frq_hz': int,
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'RmsSetting':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The rms_setting of this RmsSetting.  # noqa: E501
        :rtype: RmsSetting
        """
    ...
    def lower_frq_hz(self):
        """Gets the lower_frq_hz of this RmsSetting.

        取得する周波数帯域の下限値 (単位：Hz)    <!--省略時：10Hz  -->   # noqa: E501

        :return: The lower_frq_hz of this RmsSetting.
        :rtype: int
        """
    ...
    def lower_frq_hz(self, lower_frq_hz):
        """Sets the lower_frq_hz of this RmsSetting.

        取得する周波数帯域の下限値 (単位：Hz)    <!--省略時：10Hz  -->   # noqa: E501

        :param lower_frq_hz: The lower_frq_hz of this RmsSetting.
        :type lower_frq_hz: int
        """
    ...
    def upper_frq_hz(self):
        """Gets the upper_frq_hz of this RmsSetting.

        取得する周波数帯域の上限値 (単位：Hz)    <!--省略時：80kHz  -->   # noqa: E501

        :return: The upper_frq_hz of this RmsSetting.
        :rtype: int
        """
    ...
    def upper_frq_hz(self, upper_frq_hz):
        """Sets the upper_frq_hz of this RmsSetting.

        取得する周波数帯域の上限値 (単位：Hz)    <!--省略時：80kHz  -->   # noqa: E501

        :param upper_frq_hz: The upper_frq_hz of this RmsSetting.
        :type upper_frq_hz: int
        """
    ...
    @property
    def time_sec(self):
        """Gets the time_sec of this RmsSetting.

        測定時間 (単位：sec)     # noqa: E501

        :return: The time_sec of this RmsSetting.
        :rtype: float
        """
    ...
    def time_sec(self, time_sec):
        """Sets the time_sec of this RmsSetting.

        測定時間 (単位：sec)     # noqa: E501

        :param time_sec: The time_sec of this RmsSetting.
        :type time_sec: float
        """
