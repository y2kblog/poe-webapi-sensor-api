...
class Raw(Model):
    ...
    def __init__(self, is_running=None, dst_ip=None, dst_port=None, frq_hz=160000, data_num=None):  # noqa: E501
        ...
        :param is_running: The is_running of this Raw.  # noqa: E501
        :type is_running: bool
        :param dst_ip: The dst_ip of this Raw.  # noqa: E501
        :type dst_ip: List[int]
        :param dst_port: The dst_port of this Raw.  # noqa: E501
        :type dst_port: int
        :param frq_hz: The frq_hz of this Raw.  # noqa: E501
        :type frq_hz: int
        :param data_num: The data_num of this Raw.  # noqa: E501
        :type data_num: int
        """
        self.openapi_types = {
            'is_running': bool,
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'Raw':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The raw of this Raw.  # noqa: E501
        :rtype: Raw
        """
    ...
    @property
    def is_running(self):
        """Gets the is_running of this Raw.

        生値取得状態   falseのとき、他のパラメータは送信されない   # noqa: E501

        :return: The is_running of this Raw.
        :rtype: bool
        """
    ...
    def is_running(self, is_running):
        """Sets the is_running of this Raw.

        生値取得状態   falseのとき、他のパラメータは送信されない   # noqa: E501

        :param is_running: The is_running of this Raw.
        :type is_running: bool
        """
    ...
    @property
    def dst_ip(self):
        """Gets the dst_ip of this Raw.

        送信先IPアドレス   省略時：HTTPリクエストの送信元IP   # noqa: E501

        :return: The dst_ip of this Raw.
        :rtype: List[int]
        """
        return self._dst_ip
    ...
    def dst_ip(self, dst_ip):
        """Sets the dst_ip of this Raw.

        送信先IPアドレス   省略時：HTTPリクエストの送信元IP   # noqa: E501

        :param dst_ip: The dst_ip of this Raw.
        :type dst_ip: List[int]
        """
    ...
    @property
    def dst_port(self):
        """Gets the dst_port of this Raw.

        送信先ポート番号  # noqa: E501

        :return: The dst_port of this Raw.
        :rtype: int
        """
    ...
    def dst_port(self, dst_port):
        """Sets the dst_port of this Raw.

        送信先ポート番号  # noqa: E501

        :param dst_port: The dst_port of this Raw.
        :type dst_port: int
        """
        if dst_port is None:
    ...
    @property
    def frq_hz(self):
        """Gets the frq_hz of this Raw.

        サンプリング周波数 (単位：Hz)     # noqa: E501

        :return: The frq_hz of this Raw.
        :rtype: int
        """
        return self._frq_hz
    ...
    def frq_hz(self, frq_hz):
        """Sets the frq_hz of this Raw.

        サンプリング周波数 (単位：Hz)     # noqa: E501

        :param frq_hz: The frq_hz of this Raw.
        :type frq_hz: int
        """
    ...
    @property
    def data_num(self):
        """Gets the data_num of this Raw.

        データ数   省略時：生値取得終了コマンドを受け取るまでデータを送信し続ける   # noqa: E501

        :return: The data_num of this Raw.
        :rtype: int
        """
    ...
    def data_num(self, data_num):
        """Sets the data_num of this Raw.

        データ数   省略時：生値取得終了コマンドを受け取るまでデータを送信し続ける   # noqa: E501

        :param data_num: The data_num of this Raw.
        :type data_num: int
        """
