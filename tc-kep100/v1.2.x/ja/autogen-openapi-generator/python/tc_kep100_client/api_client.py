...
from tc_kep100_client import rest
from tc_kep100_client.configuration import Configuration
from tc_kep100_client.exceptions import ApiTypeError, ApiValueError, ApiException
from tc_kep100_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.add_alert_setting  # this is an instance of the class Endpoint
        api_instance.add_alert_setting()  # this invokes api_instance.add_alert_setting.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_alert_setting.callable or self.callable in this class
