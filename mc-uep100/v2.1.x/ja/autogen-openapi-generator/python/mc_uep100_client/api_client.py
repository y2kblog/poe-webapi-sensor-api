...
from mc_uep100_client import rest
from mc_uep100_client.configuration import Configuration
from mc_uep100_client.exceptions import ApiTypeError, ApiValueError, ApiException
from mc_uep100_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.info_get  # this is an instance of the class Endpoint
        api_instance.info_get()  # this invokes api_instance.info_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.info_get.callable or self.callable in this class
