...
class CalibrationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.calibration_get = _Endpoint(
            settings={
        ...
        self.calibration_put = _Endpoint(
            settings={
                'response_type': (ThermocoupleCalib,),
                'auth': [
                    'basicAuth'
