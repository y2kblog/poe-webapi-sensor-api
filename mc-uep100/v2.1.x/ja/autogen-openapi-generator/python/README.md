...
```sh
pip install "git+https://github.com/y2kblog/poe-webapi-sensor-api.git#egg=MC-UEP100-python&subdirectory=mc-uep100/v2.1.x/ja/autogen-openapi-generator/python"
```
(you may need to run `pip` with root permission: `sudo pip install "git+https://github.com/y2kblog/poe-webapi-sensor-api.git#egg=MC-UEP100-python&subdirectory=mc-uep100/v2.1.x/ja/autogen-openapi-generator/python"`)
