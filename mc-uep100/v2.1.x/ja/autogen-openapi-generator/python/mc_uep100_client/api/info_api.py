...
from mc_uep100_client.api_client import ApiClient, Endpoint as _Endpoint
    ...
    def __init__(self, api_client=None):
        ...
        def __info_patch(
            ...
            **kwargs
            ...
            >>> thread = api.info_patch(async_req=True)
            >>> result = thread.get()


            Keyword Args:
                info_configurable (InfoConfigurable): 省略したパラメータは変更されない. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.info_patch = _Endpoint(
            settings={
                'response_type': (InfoConfigurable,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/info',
                'operation_id': 'info_patch',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
